...
export default function MarkRentPaidConfirmModal({
  monthLabel,
  propertyName,
  amount,
  busy = false,
  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="mark-rent-paid-title"
      ...
      >
        ...
        <h2 id="mark-rent-paid-title" className="text-center text-xl font-bold text-[#2D3748]">
          <span aria-hidden="true">📤 </span>
          Mark {monthLabel} as Paid
        </h2>
        ...
        <p className="mt-4 text-center text-sm leading-relaxed text-[#4A5568]">
          ...
          <strong>{monthLabel}</strong> as paid?
        </p>

        <div className="mt-6 rounded-xl border border-[#E2E8F0] bg-[#F7FAFC] px-5 py-4 text-center">
          <p className="text-xs font-semibold uppercase tracking-wide text-[#A0AEC0]">Amount</p>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <button
            ...
            disabled={busy}
            onClick={onConfirm}
            className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-[#E88D5B] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#d97a48] disabled:opacity-60"
          >
            {busy ? (
              'Processing…'
            ) : (
